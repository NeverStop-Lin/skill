...
const managerConfig = {
    DATA_FILE_MD5: '57d6451cb133a7c8',
    CODE_FILE_MD5: '3d3340e88209de46',
    GAME_NAME: 'webgl',
    APPID: '',
    DATA_FILE_SIZE: '10907411',
    OPT_DATA_FILE_SIZE: '$OPT_DATA_FILE_SIZE',
    DATA_CDN: 'https://res-1305296755.cos.ap-guangzhou.myqcloud.com/2025/Temp(里面内容定期清理)/shali/v10/',
    // 资源包是否作为小游戏分包加载
